...
from backend.src.core.semiproducts.models.models import Semiproduct
from backend.src.core.semiproducts.service.semiproducts_service import SemiproductService
